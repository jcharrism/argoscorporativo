...
$demo_url = 'https://wow-company.com/preview/wordpress-plugins/side-menu-pro/';
?>
    ...
    <div class="container">
        <div class="block has-text-centered ds-title">
            ...
            <div class="button-group">
                <a href="<?php echo esc_url( $pro_url ); ?>" class="like-button pro-button">Get More with Pro</a>
                <a href="<?php echo esc_url( $demo_url ); ?>" class="like-button demo-button">Demo</a>
            </div>
        </div>
        <div class="columns is-multiline is-variable is-3 feature-boxes">
            ...
            <div class="column is-full-mobile is-one-quarter-desktop is-half-tablet ">
                <div class="box has-text-centered has-text-grey feature-box is-radiusless">
                    ...
                    <div class="content">
                        <p class="title is-5 ">Tooltips for options</p>
                    </div>
                </div>
            </div>
