...
});jQuery(".filtro-etiquetas-select #ofcategory option[value=0]").text("Todos");
jQuery(".filtro-etiquetas-select #ofpost_tag option[value=0]").text("Todas");
